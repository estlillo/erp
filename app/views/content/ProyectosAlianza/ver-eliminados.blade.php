...
<div class="div azul-principal fuente-blanca">
     <h1><i class="fa fa-chevron-right"></i> Proyectos alianza eliminados</h1>
</div>
        ...
        <table class="table table-responsive ">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a style="text-decoration: none; color: #FFFFFF;" href="{{URL::to('historico', [$project->id])}}"><i title="Mover a historico" class="fa fa-book fa-2x hover-grey"></i></a></td>
